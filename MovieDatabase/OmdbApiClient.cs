...
namespace MovieDatabase {
    internal class OmdbApiClient {
        ...
        public async Task<ClassResponseSearch> GetBySearch(string inputSearchTerm, string inputYear, string inputType) {
        ...
        public async Task<ClassTitle> GetByImdbId(string imdbID) {
            HttpClient httpClient;
            httpClient = new HttpClient();
            httpClient.BaseAddress = new Uri("http://www.omdbapi.com");
